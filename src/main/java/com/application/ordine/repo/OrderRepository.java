...
public interface OrderRepository extends MongoRepository<Order, ObjectId> {
    ...
    default List<Order> findOrdersByCriteria(String userName, LocalDateTime orderedAt, LocalDateTime deliveredAt, Double minPrice, Double maxPrice) {
        ...
        if (orderedAt != null && deliveredAt != null) {
            criteria.andOperator(
                    Criteria.where("orderedAt").gte(orderedAt),
        ...
        if (orderedAt != null && deliveredAt != null) {
            query.addCriteria(
                    Criteria.where("orderedAt").gte(orderedAt).lte(deliveredAt)
                            .and("deliveredAt").lte(deliveredAt).gte(orderedAt)
            );
        } else if (orderedAt != null) {
